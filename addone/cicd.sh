...
custom-fedx-web(){
  sudo docker pull registry.zet-fl.com/msmp/fedx-shanghai-spdb-web:4.2.1
  sudo docker save registry.zet-fl.com/msmp/fedx-shanghai-spdb-web:4.2.1 |pigz -9 >custom-fedx-web.tgz
}
